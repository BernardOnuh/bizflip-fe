...
<div>
      <p>
        ...
        the Services. <br /> Bizflip provides an avenue for sellers and
        ...
        responsible for the purchase of the assets. <br />
      </p>
      <p>
      ...
      <p>Bizflip is not responsible for:</p>
      <ul className={styles.listAlphabetic}>
        <li>the existence, quality, suitability of legality of a listed asset;</li>
        <li>the truth, accuracy or completeness of the information contained in a listing;</li>
        <li>the future performance of a listed asset;</li>
        <li>the performance or conduct of a buyer or seller or third-party on the Website; and/or</li>
        <li>the quality, suitability or ability of a third party which provides goods or services to Bizflip or to a buyer or seller.</li>
      </ul>
      <p>
    ...
    <h3>9. Listing Types </h3>
      ...
      <p>
        You must not post or send any content that contains software
        ...
        absolute discretion. While comments and reviews are visible to
    ...
    <h3>18. Confidential Information</h3>
      ...
      <p>Bizflip will not be responsible for:</p>
      <ul className={styles.listAlphabetic}>
        <li>
    ...
    <div>
      ...
      <p>
        You agree to hold Bizflip, its principals, officers,
