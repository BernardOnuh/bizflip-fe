    ...
    <div className={styles.root} id="learnmore">
      <div className={styles.learnmoreContent}>
        ...
        <div className={styles.bodyText}>
          ...
          ecommerce, brick and mortar, hybrid dapps, etc. What do we mean by
          ...
          escrow. We are in the beginning stages of our journey to service our
        ...
        <div className={styles.bodyText}>
          ...
          to committing to the acquisition. Whether you want to invest in
          someone’s asset or acquire it, it’s never been faster, safer, or easier
          to see exactly what the marketplace is offering and make an informed
