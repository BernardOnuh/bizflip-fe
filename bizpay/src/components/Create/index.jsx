...
import nftIcon from '../../../public/images/svgs/nft_black.svg';
import uploadIcon from '../../../public/images/imgs/upload.png';
                ...
                try {
                  ...
                  try {
                    ...
                    signature = await signer.signMessage(
                      `Approve Signature on Bizflip.io with nonce ${nonce}`
                    );
                  } catch (err) {
                    toast(
                      'error',
          ...
          <div className={styles.inputGroup}>
            ...
            <div className={cx(styles.inputWrapper, styles.categoryList)}>
              ...
              {selectedCategories.map((cat, idx) => (
                ...
                >
                  <Image src={cat.icon} className={styles.categoryIcon} />
                  <span className={styles.categoryLabel}>{cat.label}</span>
            ...
            <div className={styles.inputWrapper}>
              <div className={styles.linksWrapper}>
                  ...
                  <>
                    ...
                    >
                      <div className={styles.linkIconWrapper}>
                        <Image src={nftIcon} className={styles.linkIcon} />
                      </div>
                      <input
                ...
                <div className={styles.linkItem}>
                  <div className={styles.linkIconWrapper}>
                    <Image src={webIcon} className={styles.linkIcon} />
                  </div>
                  <input
                    className={styles.linkInput}
                ...
                <div className={styles.linkItem}>
                  <div className={styles.linkIconWrapper}>
                    <Image src={discordIcon} className={styles.linkIcon} />
                  </div>
                  <input
                    className={styles.linkInput}
                ...
                <div className={styles.linkItem}>
                  <div className={styles.linkIconWrapper}>
                    <Image src={twitterIcon} className={styles.linkIcon} />
                  </div>
                  <input
                    className={styles.linkInput}
                ...
                <div className={styles.linkItem}>
                  <div className={styles.linkIconWrapper}>
                    <Image src={instagramIcon} className={styles.linkIcon} />
                  </div>
                  <input
                    className={styles.linkInput}
                ...
                <div className={styles.linkItem}>
                  <div className={styles.linkIconWrapper}>
                    <Image src={mediumIcon} className={styles.linkIcon} />
                  </div>
                  <input
                    className={styles.linkInput}
                ...
                <div className={styles.linkItem}>
                  <div className={styles.linkIconWrapper}>
                    <Image src={telegramIcon} className={styles.linkIcon} />
                  </div>
                  <input
                    className={styles.linkInput}
