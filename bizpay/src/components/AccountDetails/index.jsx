...
// Removed toast and useApi as per preferences
...
import IconList from '../../../public/images/icons/iconList';
import IconHeart from '../../../public/images/icons/iconHeart';
import IconClock from '../../../public/images/icons/iconClock';
...
const AccountDetails = () => {
    ...
    const uid  = "0x80E387bbF665b61ADc0e41009bF3f3668b4775Eb";
    ...
    const [rewardPointsModalVisible, setRewardPointsModalVisible] = useState(
      false
    );
    ...
    const showPointModal = () => {
      setRewardPointsModalVisible(true);
    };
    ...
    return (
      <div className={styles.container}>
        <div className={styles.profile}>
          ...
          <div className={styles.wrapper}>
            ...
            <div className={styles.bottomWrapper}>
              ...
              <div className={styles.followers} onClick={showPointModal}>
                {loading ? (
                  <Skeleton width={100} height={24} />
                ) : (
                  <>
                    <b>{user.point || 0}</b> Points
                  </>
                )}
              </div>
            </div>
                ...
                <div className={styles.activityList}>
                  {(bidsLoading
                    ...
                    <div key={idx} className={styles.activity}>
                      ...
                      <div className={styles.quantity}>
                        {bid ? bid.type : <Skeleton width={80} height={20} />}
                      </div>
                      <div className={styles.date}>
                        {bid ? (
        ...
        <RewardPointsModal
          visible={rewardPointsModalVisible}
          point={user.point || 0}
          onClose={() => setRewardPointsModalVisible(false)}
        />
        <NewBundleModal
